  ...
  */
	...
	hitTestCircle(c1, c2, global = false) {
		...
		if (global) {
			...
			vx =
				c2.gx + c2.width / 2 - c2.xAnchorOffset - (c1.gx + c1.width / 2 - c1.xAnchorOffset);
			vy =
				c2.gy + c2.width / 2 - c2.yAnchorOffset - (c1.gy + c1.width / 2 - c1.yAnchorOffset);
		} else {
  ...
  */
	contain(sprite, container, bounce = false, extra = undefined) {
		...
		if (
			...
			sprite.x =
				container.x - sprite.parent.gx - container.xAnchorOffset + sprite.xAnchorOffset;
		...
		if (
			...
			if (sprite.mass) sprite.vy /= sprite.mass;
			sprite.y =
				container.y - sprite.parent.gy - container.yAnchorOffset + sprite.yAnchorOffset;
			collision.add('top');
		}
		...
		if (
			...
			if (sprite.mass) sprite.vx /= sprite.mass;
			sprite.x =
				container.width - sprite.width - container.xAnchorOffset + sprite.xAnchorOffset;
			collision.add('right');
		}
		...
		if (
			...
			if (sprite.mass) sprite.vy /= sprite.mass;
			sprite.y =
				container.height - sprite.height - container.yAnchorOffset + sprite.yAnchorOffset;
			collision.add('bottom');
		}
